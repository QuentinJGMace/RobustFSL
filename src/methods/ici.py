...
class ICI(AbstractMethod):
    def __init__(self, backbone, device, log_file, args):
        ...
        try:
            ...
            raise ValueError(
                "Your version of sklearn is propably to recent for this code to run, argument normalizer is deprecated since sklearn 1.2"
            )
    ...
    def run_task(self, task_dic, shot):
        ...
        support, query = self.normalizer(support, query, train_mean=train_mean)
    ...
    def run_method(
        self, support_features, query_features, support_labels, query_labels, **kwargs
    ):
        ...
        for i in tqdm(range(n_tasks)):
            ...
            support_X, support_y = (
                support_features.cpu().numpy()[i],
                support_labels.cpu().numpy()[i],
            )
        ...
        self.record_acc(probs_q=probs_q, y_q=query_labels)
